...
class CloudAdvisor {
    ...
    recommend(language, type) {
        ...
        return this.providers.filter(p => {
            ...
            if (type === 'frontend' && (p.name === 'Vercel' || p.name === 'Netlify'))
                return true;
            if (type === 'backend' && (p.name === 'Railway' || p.name === 'Render' || p.name === 'Fly.io'))
                return true;
            return supportsLang;
        }).sort((a, b) => {
...
exports.CloudAdvisor = CloudAdvisor;
