...
export class PythonGenerator extends BaseGenerator {
  ...
  private createRequirementsTxt(_config: ProjectConfig): GeneratedFile {
...
requests==2.31.0
  ...
  private createMainPy(config: ProjectConfig): GeneratedFile {
...
if __name__ == "__main__":
  ...
  private createStructure(config: ProjectConfig): GeneratedFile[] {
