...
import { ProjectConfig, GeneratorOutput } from '../../interfaces';
...
export class NodeGenerator extends BaseGenerator {
  ...
  private createPackageJson(config: ProjectConfig) {
  ...
  private createIndexFile(config: ProjectConfig) {
...
app.listen(port, () => {
  ...
  private createStructure(_config: ProjectConfig) {
